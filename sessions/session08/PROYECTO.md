...
| ![laser1](assets/laser1.gif) | ![laser2](assets/laser2.gif) | ![laser3](assets/laser3.gif) |
| ---------------------------- | ---------------------------- | ---------------------------- |

El proyecto deberá tener tres partes diferenciadas:

1. **Cliente web en Astro**  
   Interfaz visual e interactiva desde la que el usuario controla la pieza.

2. **Servidor en Node.js con Socket.IO**  
   Servidor intermedio encargado de recibir eventos del cliente web y comunicarlos en tiempo real.

3. **Cliente externo en Node.js con Socket.IO Client**  
